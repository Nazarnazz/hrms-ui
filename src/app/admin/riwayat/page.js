...
export default function Riwayat() {
  ...
  const Riwayat = [
    {
      id: 1,
      nama: "Nazar Aulia Dukun Santet",
      divisi: "IT",
      masuk: "07:43",
      keluar: "17:02",
      method: "both",
      notes: "catatan bahwa mereka hadir atau ada keterangan lain",
      status: "hadir",
      ...
      <Layout>
        <div className="p-4 mt-12">
          ...
          <div className="grid md:grid-cols-3 grid-cols-2 gap-2">
            ...
            <div className="hidden lg:flex gap-2 md:justify-end relative">
                ...
                <TableBody>
                  {paginatedRiwayat.map((item, index) => (
                    <TableRow key={item.id}>
                      ...
                      <TableCell>{item.face_in}</TableCell>
                      <TableCell>{item.face_out}</TableCell>
