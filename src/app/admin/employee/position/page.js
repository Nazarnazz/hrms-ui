...
export default function Position() {
  ...
  const paginatedPosition = Position.slice(startIndex, endIndex);
  const totalPages = Math.ceil(Position.length / itemsPerPage);
      ...
      <Layout>
        <div className="p-4 mt-12">
          ...
          {isLoading ? (
            ...
            <div>
              <span className="text-[20px] mt-4 ">Position</span>
