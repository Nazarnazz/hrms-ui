                      ...
                      <TableRow>
                        ...
                        <TableHeader>
                          <div className="flex items-center">
                            Department
                            <svg onClick={() => handleSort("department")} className="w-3 h-3 ms-1.5 hover:text-blue-900 dark:hover:text-gray-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
