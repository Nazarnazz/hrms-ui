...
export default function Riwayat() {
  ...
  const [visibleColumns, setVisibleColumns] = useState(["Status", "Jabatan"]);

  const allColumns = ["Status", "Jabatan"];
                  ...
                  <Table>
                    <TableHead>
                      <TableRow>
                        ...
                        {visibleColumns.includes("Status") && <TableHeader className={`text-center`}>Status</TableHeader>}
                    ...
                    <TableBody>
                      {data.map((item) => (
                        <TableRow key={item.id}>
                          ...
                          {visibleColumns.includes("Jabatan") && <TableCell>{item.jabatan}</TableCell>}
                          <TableCell>
