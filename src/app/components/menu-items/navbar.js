        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              <div className="flex gap-2 ms-2 md:me-24">
                <Image width={40} height={40} alt="wpr" src="/assets/image/wpr-logo-white.png" className="hidden dark:block" />
                <Image width={40} height={40} alt="wpr" src="/assets/image/wpr-logo-blue.png" className="dark:hidden" />
                <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-blue-800 dark:text-white">HRMS</span>
              </div>
            </div>
