    ...
    <div className="embla relative w-full">
      <div className="embla__viewport overflow-hidden px-3 pb-3 pt-5" ref={emblaRef}>
        <div className="embla__container flex gap-6">
          <div className=" flex-[0_0_13%]  bg-blue-50 dark:bg-[#0d0f20] border dark:border-white shadow shadow-gray-600 dark:shadow-white rounded-lg px-3 py-5 flex flex-col items-center justify-center">
